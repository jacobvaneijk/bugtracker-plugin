<template>
    <div class="bt-popover-wrapper" @click="onWrapperClick">
        <div class="popover" :class="{ 'is-disabled': loading, 'has-heading': $slots.heading }" :style="{ top: y + 'px', left: x + 'px' }">
            <div class="popover__heading" v-if="$slots.heading">
                <slot name="heading"></slot>
            </div>

            <slot></slot>

            <div class="popover__actions" v-if="$slots.actions">
